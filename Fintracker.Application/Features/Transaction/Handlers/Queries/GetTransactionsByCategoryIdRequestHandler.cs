...
public class GetTransactionsByCategoryIdRequestHandler: IRequestHandler<GetTransactionsByCategoryIdRequest, IReadOnlyList<TransactionBaseDTO>>
{
    ...
    public async Task<IReadOnlyList<TransactionBaseDTO>> Handle(GetTransactionsByCategoryIdRequest request, CancellationToken cancellationToken)
    {
