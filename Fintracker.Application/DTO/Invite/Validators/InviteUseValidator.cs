...
{
    public InviteUseValidator(IUserRepository userRepository, IUnitOfWork unitOfWork, IHttpContextAccessor accessor)
    {
        ...
        RuleFor(x => x.UserEmail)
            ...
            .NotEqual(x => accessor.HttpContext!.User.FindFirst(ClaimTypeConstants.Email)!.Value)
